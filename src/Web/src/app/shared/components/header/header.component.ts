...
@Component({
  ...
  `,
  styles: [`
    .top-header { height: 64px; background: #ffffff; border-bottom: 1px solid #e2e8f0; display: flex; align-items: center; justify-content: space-between; padding: 0 1.75rem; margin-left: 220px; position: sticky; top: 0; z-index: 90; font-family: 'Inter', system-ui, sans-serif; }
    .search-container { position: relative; width: 340px; }
    .search-icon { position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); width: 16px; height: 16px; color: #94a3b8; }
    ...
    .user-profile { display: flex; align-items: center; margin-left: 0.5rem; }
